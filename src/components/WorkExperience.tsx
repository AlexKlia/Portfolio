...
export default function WorkExperience({experiences}: Props) {
  return (
    <motion.div
        ...
        viewport={{once: true}} className='flex flex-col relative h-screen text-left overflow-hidden md:flex-row max-w-full px-10 justify-evenly mx-auto items-center'>
